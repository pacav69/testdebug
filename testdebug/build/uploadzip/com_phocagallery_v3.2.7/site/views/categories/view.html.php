...
class PhocaGalleryViewCategories extends JView
{
	...
	/*	if ($this->params->get('image') != -1) {
		...
		//$this->tmpl['ns'] = PhocaGalleryRenderInfo::getPhocaIc((int)$this->params->get( 'display_phoca_info', 1 ));
		$this->tmpl['abn'] = '<div style="text-align: center; color: rgb(211, 211, 211);display:block;">Powe'. 'red by <a href="http://www.phoca.cz/phocaga'. 'llery" style="text-decoration: none;" target="_blank" title="Phoca Gal'. 'lery">Pho'.'ca Gall'. 'ery</a></div>';
