 ...
 * UncleBill Model
 */
class UncleBillModelUncleBill extends JModelItem {
	/**
	 *
	 * @var object item
	 */
	...
	public function getItem() {
		if (! isset ( $this->item )) {
			...
			$this->_db->setQuery ( $this->_db->getQuery ( true )->from ( '#__unclebill as h' )->leftJoin ( '#__categories as c ON h.catid=c.id' )->select ( 'h.greeting, h.params, c.title as category' )->where ( 'h.id=' . ( int ) $id ) );
