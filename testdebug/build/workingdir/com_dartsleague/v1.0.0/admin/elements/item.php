<?php
/**
 * @version		$Id: item.php 478 2010-06-16 16:11:42Z SilverPC Consultants. $
 * @package		dartsleague
...
class JElementItem extends JElement
{
	...
	function fetchElement($name, $value, & $node, $control_name)
	{
		...
		$item = & JTable::getInstance('dartsleagueItem', 'Table');
		...
		$link = 'index.php?option=com_dartsleague&amp;view=items&amp;task=element&amp;tmpl=component&amp;object='.$name;
