<?php
/**
 * @version		$Id: userslatest.php 478 2010-06-16 16:11:42Z SilverPC Consultants. $
 * @package		dartsleague
...
class JElementUsersLatest extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name){
		...
		<div class="button2-left">
			<div class="blank">
				<a class="modal" title="' .JText::_ ( 'Click to select one or more users' ). '"  href="index.php?option=com_dartsleague&view=users&task=element&tmpl=component" rel="{handartsleagueer: \'iframe\', size: {x: 700, y: 450}}">'.JText::_('Click to select one or more users').'</a>
			</div>
		</div>
