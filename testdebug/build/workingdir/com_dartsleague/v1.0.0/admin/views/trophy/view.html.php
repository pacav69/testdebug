...
class dlViewCategory extends JView
{
	...
	function display($tpl = null)
	{
		...
		$query = 'SELECT ordering AS value, name AS text FROM #__dl_categories ORDER BY ordering';
		...
		$dlPlugins=$dispatcher->trigger('onRenderAdminForm', array (&$category, 'category' ) );
		...
		JToolBarHelper::cancel();
                        // new toolbar
        JToolBarHelper::help( 'screen.trophy',true ); 
