...
class dartsleagueViewCategories extends JView
{
	...
	function display($tpl = null)
	{
		...
		$categoryModel= new dartsleagueModelCategory;
		...
		//JToolBarHelper::title(JText::_('Categories'), 'dartsleague.png');
		...
		JToolBarHelper::preferences('com_dartsleague', '500', '600');
                // new toolbar
        JToolBarHelper::help( 'screen.schedules',true ); 
		...
		//JSubMenuHelper::addEntry(JText::_('Categories'), 'index.php?option=com_dartsleague&view=categories', true);
	...
	function move(){
		...
		JToolBarHelper::title( JText::_('Move categories'), 'dartsleague.png' );
