...
<!--        <th><?php echo JHTML::_('grid.sort', 'Email', 'email', @$this->lists['order_Dir'], @$this->lists['order']); ?></th>
    ...
    <tbody>
      ...
      <tr class="<?php echo "row$k"; ?>">
        <td><?php echo $i+1; ?></td>
        <td><a class="dlListplayerDisabled" title="<?php echo JText::_('Click to add this season'); ?>" onclick="window.parent.jSelectteam('<?php echo $row->id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""),$row->title); ?>', 'id');"><?php echo $row->title; ?></a></td>
