  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'Description', 'description', @$this->lists['order_Dir'], @$this->lists['order']); ?></th>
    ...
    <tbody>
      ...
      $k = 0; $i = 0;	$n = count( $this->rows );
			...
			foreach ($this->rows as $row) :
				...
				$link = JRoute::_('index.php?option=com_dl&view=season&cid='.$row->id);
			?>
...
<!--				<td class="dlOrder">
                    ...
                    <!-- <td>
                    <a href="<?php echo JRoute::_('index.php?option=com_dl&view=category&cid='.$row->catid);?>"><?php echo $row->category; ?></a>
                    </td> -->
<!--				<td>
					<?php if($user->gid>23):?>
...
<!--                    <td class="dlDate"><?php echo JHTML::_('date', $row->created , JText::_('DL_DATE_FORMAT')); ?>
                    </td>   -->
<!--                <td class="dlDate"><?php echo ($row->modified == $nullDate) ? JText::_('Never') : JHTML::_('date', $row->modified , JText::_('DL_DATE_FORMAT')); ?></td>-->
<!--                <td><?php echo $row->hits ?></td>-->
<!--				<td class="dlCenter">
					<?php if (JFile::exists(JPATH_SITE.DS.'media'.DS.'dl'.DS.'seasons'.DS.'cache'.DS.md5("Image".$row->id).'_XL.jpg')): ?>
					<a href="<?php echo JURI::root().'media/dl/seasons/cache/'.md5("Image".$row->id).'_XL.jpg';?>" class="modal"><img src="templates/khepri/images/menu/icon-16-media.png" alt="<?php echo JText::_('Preview image');?>" /></a>
					<?php endif; ?>
				</td>  
                -->
