...
class dlViewseasons extends JView
{
...
//		$lists['featured'] = JHTML::_('select.genericlist', $filter_featured_options, 'filter_featured', 'onchange="this.form.submit();"', 'value', 'text', $filter_featured);
		...
		JToolBarHelper::title( JText::_('Seasons'), 'dl.png' );
		if ($filter_trash == 1) {
			JToolBarHelper::custom('restore','restore.png','restore_f2.png','Restore', true);
			JToolBarHelper::deleteList('Are you sure you want to delete selected Season?', 'remove', 'Delete');
		}
		else{
		...
		JToolBarHelper::preferences('com_dl', '500', '600');
                // new toolbar
        JToolBarHelper::help( 'screen.seasons',true ); 
        ...
        JSubMenuHelper::addEntry(JText::_('Players'), 'index.php?option=com_dl&view=players');
                                                                        // new menu 
        JSubMenuHelper::addEntry(JText::_('Seasons'), 'index.php?option=com_dl&view=seasons',true);
                                                                                // new menu 
	...
	function move(){
		...
		JToolBarHelper::title( JText::_('Move team'), 'dl.png' );
