 ...
 * @package		dartsleague player element
...
<form action="index.php" method="post" name="adminForm">
	...
	<h1><?php echo JText::_('Select players'); ?></h1>
  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th><?php echo JHTML::_('grid.sort', 'Alias', 'plalias', @$this->lists['order_Dir'], @$this->lists['order']); ?></th>
    ...
    <tbody>
      ...
      <tr class="<?php echo "row$k"; ?>">
        ...
        <td class="dartsleagueCenter"><?php echo $row->plalias;?></td>
        <td class="dartsleagueCenter"><?php echo $row->email; ?></td>
        <td class="dartsleagueCenter"><?php echo $row->mobile; ?></td> 
