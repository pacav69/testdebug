...
<script type="text/javascript">
	...
	function submitbutton(pressbutton) {
		...
		if (trim( document.adminForm.name.value ) == "") {
			alert( '<?php echo JText::_('A Team must at least have a title!', true);?>' );
		} else {
			submitform( pressbutton );
		}
	}
        ...
        <td>
					...
					<fieldset class="adminform">
						...
						<table class="admintable">
							<tr>
								<td class="key"><?php echo JText::_('Team Name'); ?></td>
								<td><input class="text_area dlTitleBox" type="text" name="name" id="name" value="<?php echo $this->row->name; ?>" maxlength="250" /></td>
							</tr>
<!--							<tr>
								<td class="key"><?php echo JText::_('Title alias'); ?></td>
								<td><input class="text_area dlTitleBox" type="text" name="alias" value="<?php echo $this->row->alias; ?>" maxlength="250" /></td>
							</tr> -->
     						<tr>
								<td class="key"><?php	echo JText::_('Venue'); ?></td>
								<td><?php echo $this->lists['venueid']; ?></td>
							</tr>
<!--                            <tr>
                                <td class="key"><?php    echo JText::_('Venue'); ?></td>
                                <td><?php echo $this->row->catid; ?></td>
                            </tr>  -->
<!--                            <tr>
				  ...
				  <div class="simpleTabs">
				    ...
				    <div class="simpleTabsContent">
							<div class="dlItemFormEditor">
								<span class="dlItemFormEditorTitle">
									<?php echo JText::_('Team description'); ?>
								</span>
				    ...
				    <div class="simpleTabsContent">
							<table class="admintable">
							  <tr>
							    <td align="right" class="key"><?php echo JText::_('team image'); ?></td>
							    <td>
							    	<input type="file" name="image" class="fileUpload" /> 
										<?php if (!empty($this->row->image)): ?>
										<img src="<?php echo JURI::root();?>media/dl/teams/<?php echo $this->row->image; ?>" alt="<?php echo $this->row->name;?>" class="dlAdminImage" /> 
...
<!--					<?php if (count($this->dlPlugins)):?>
				...
				<!--<td id="adminFormdlSidebar">
					<fieldset class="adminform">
						...
						echo $pane->startPanel( JText::_( 'team item layout' ), 'team-item-layout' );
						echo $this->form->render('params','team-item-layout');
						echo $pane->endPanel();
						
						echo $pane->startPanel( JText::_( 'team view options' ), 'team-view-options' );
						echo $this->form->render('params','team-view-options');
						echo $pane->endPanel();
						...
						echo $pane->startPanel( JText::_( 'Item view options in team listings' ), 'item-view-options-listings' );
