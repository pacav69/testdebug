  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th><?php echo JHTML::_('grid.sort', 'Boardnum', 'boardnum', @$this->lists['order_Dir'], @$this->lists['order']); ?></th>
    ...
    <tbody>
      ...
      <tr class="<?php echo "row$k"; ?>">
        <td><?php echo $i+1; ?></td>
        <td><a class="dartsleagueListvenueDisabled" title="<?php echo JText::_('Click to add this venue'); ?>" onclick="window.parent.jSelectvenue('<?php echo $row->id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""),$row->title); ?>', 'id');"><?php echo $row->title; ?></a></td>
