...
<form action="index.php" method="post" name="adminForm">
  ...
  <table class="dlAdminTableFilters">
    <tr>
      <td class="dlAdminTableFiltersSearch" style="white-space:nowrap;">
  ...
  <table class="adminlist">
    ...
    <tbody>
      ...
      <tr class="<?php echo "row$k"; ?>">
        <td><?php echo $i+1; ?></td>
        <td><a class="dlListItemDisabled" title="<?php echo JText::_('Click to add this item'); ?>" onclick="window.parent.jSelectUser('<?php echo $row->id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""),$row->name); ?>', 'id');"><?php echo $row->name; ?></a></td>
        <td class="dlCenter"><?php echo $row->username; ?></td>
