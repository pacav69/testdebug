...
/**
 * UpdDartsLeague Model
 */
class DartsLeagueModelUpdDartsLeague extends JModelForm {
	/**
	 *
	 * @var object item
	 */
	...
	public function getForm($data = array(), $loadData = true) {
		...
		// Get the form.
		$form = $this->loadForm ( 'com_dartsleague.upddartsleague', 'upddartsleague', array (
				'control' => 'jform',
				'load_data' => true 
		) );
		if (empty ( $form )) {
	...
	function &getItem() {
		if (! isset ( $this->_item )) {
			...
			$id = $this->getState ( 'dartsleague.id' );
